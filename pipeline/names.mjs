...
export const RULES = { style: 'title', prefer: ['Chisholm Institute of TAFE/Beach St'],
  // a cut "(Melbo..." between the name and the tram stop number
  stopRe: [[/ \([^()]*\.\.\. (#\d+)$/, ' $1'], [/ Tce Tce\b/, ' Tce']],
};
